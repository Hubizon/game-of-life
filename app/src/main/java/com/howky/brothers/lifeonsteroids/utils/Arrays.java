...
public class Arrays {
    ...
    private static Skill StudyAtCollage = new Skill("Study At Collage", "Student", 12500, 30);
    private static Skill GetAMastersDegree = new Skill("Get A Master's Degree", "Master's Degree", 25000, 35);
    ...
    private static Skill WeaponSkillsBeginner = new Skill("Weapon Skills Beginner", "Weapon Skills Beginner", 100, 10);
    private static Skill WeaponSkillsIntermediate = new Skill("Weapon Skills Intermediate", "Weapon Skills Intermediate", 750, 15);
    private static Skill WeaponSkillsAdvanced = new Skill("Weapon Skills Advanced", "Weapon Skills Advanced", 2500, 20);
    private static Skill ThiefSkillsBeginner = new Skill("Thief Skills Beginner", "Thief Skills Beginner", 100, 10);
    private static Skill ThiefSkillsIntermediate = new Skill("Thief Skills Intermediate", "Thief Skills Intermediate", 750, 15);
    private static Skill ThiefSkillsAdvanced = new Skill("Thief Skills Advanced", "Thief Skills Advanced", 2500, 20);
