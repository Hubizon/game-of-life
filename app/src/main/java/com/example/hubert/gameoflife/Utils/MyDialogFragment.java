    ...
    private void onTimerDelay()
    {
        ...
        switch (mId)
        {
            ...
            case R.id.GoToSchoolEducation:
                ...
                { }*/
                editor.putInt(getResources().getString(R.string.saved_education_points_key), SharedPreferencesDefaultValues.DefaultEducationPoints);
