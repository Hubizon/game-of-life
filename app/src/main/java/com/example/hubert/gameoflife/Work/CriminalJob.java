...
public class CriminalJob extends Job{
    ...
    public CriminalJob(String name, int salary, int salaryNo2, int salaryNo3, int markRatio, int additionalSkillsRes,
                       Fun minFunNeeded, Lodging minLodgingNeeded, Transport minTransportNeeded, int chanceToGetBusted/*, BlackItem[] neededBlackItems*/) {
        super(name, salary, salaryNo2, salaryNo3, markRatio, additionalSkillsRes, minFunNeeded, minLodgingNeeded, minTransportNeeded);
